(() => {
  ...
  // Desktop uses the two-tier hierarchy from the approved navigation reference.
  // Keep `routes` untouched because its order also drives mobile navigation and search.
  const desktopUtilityNavIds = ["about", "platform", "join"];
  const desktopMainNavIds = ["customized", "applied", "products", "partners", "insights"];
  ...
  const sciencePlatform = {
    en: {
      ...
      items: [
        { title: "Exposome Science", image: "science-platform-exposome.png" },
        { title: "Stress Neurobiology", image: "science-platform-neuro-pathway-stress.png" },
        { title: "Homeostasis Regulation", image: "science-platform-homeostasis-regulation.png" },
        { title: "Longevity & Aging", image: "science-platform-human-longevity-aging.png" },
        { title: "Olfactory Science", image: "science-platform-olfactory-science.png" },
        { title: "Synesthesia-Inspired Perception", image: "science-platform-pssudo-synesthesia-perception.png" },
        { title: "Neuroplasticity", image: "science-platform-neuroplasticity.png" },
        { title: "Neuro-Scented Therapy", image: "science-platform-neuro-scented-therapy.png" },
        { title: "Neuro-Skin Science", image: "science-platform-neuro-skin-care.png" },
        { title: "Hair Follicle Biology", image: "science-platform-hair-follicle-function.png" }
      ]
    },
    ja: {
      title: "サイエンスプラットフォーム",
      items: [
        { title: "エクスポソーム", image: "science-platform-exposome.png" },
        { title: "ヒューマンロンジェビティとエイジング", image: "science-platform-human-longevity-aging.png" },
        { title: "嗅覚科学", image: "science-platform-olfactory-science.png" },
        { title: "ニューロセンテッドセラピー", image: "science-platform-neuro-scented-therapy.png" },
        { title: "ニューロスキンケア", image: "science-platform-neuro-skin-care.png" },
        { title: "神経可塑性", image: "science-platform-neuroplasticity.png" },
        { title: "疑似共感覚知覚", image: "science-platform-pssudo-synesthesia-perception.png" },
        { title: "ホメオスタシス調節", image: "science-platform-homeostasis-regulation.png" },
        { title: "ストレスに関わる神経経路", image: "science-platform-neuro-pathway-stress.png" },
        { title: "毛包機能", image: "science-platform-hair-follicle-function.png" }
      ]
    },
    zh: {
      title: "科學平台",
      items: [
        { title: "暴露體", image: "science-platform-exposome.png" },
        { title: "人類長壽與老化", image: "science-platform-human-longevity-aging.png" },
        { title: "嗅覺科學", image: "science-platform-olfactory-science.png" },
        { title: "神經香氛療法", image: "science-platform-neuro-scented-therapy.png" },
        { title: "神經肌膚護理", image: "science-platform-neuro-skin-care.png" },
        { title: "神經可塑性", image: "science-platform-neuroplasticity.png" },
        { title: "擬聯覺感知", image: "science-platform-pssudo-synesthesia-perception.png" },
        { title: "恆定調節", image: "science-platform-homeostasis-regulation.png" },
        { title: "壓力相關神經路徑", image: "science-platform-neuro-pathway-stress.png" },
        { title: "毛囊功能", image: "science-platform-hair-follicle-function.png" }
      ]
    },
    th: {
      title: "แพลตฟอร์มวิทยาศาสตร์",
      items: [
        { title: "เอกซ์โพโซม", image: "science-platform-exposome.png" },
        { title: "อายุยืนและการชะลอวัยของมนุษย์", image: "science-platform-human-longevity-aging.png" },
        { title: "วิทยาศาสตร์การรับกลิ่น", image: "science-platform-olfactory-science.png" },
        { title: "การบำบัดด้วยกลิ่นผ่านระบบประสาท", image: "science-platform-neuro-scented-therapy.png" },
        { title: "การดูแลผิวผ่านระบบประสาท", image: "science-platform-neuro-skin-care.png" },
        { title: "ความยืดหยุ่นของสมอง", image: "science-platform-neuroplasticity.png" },
        { title: "การรับรู้แบบ Pssudo-Synesthesia", image: "science-platform-pssudo-synesthesia-perception.png" },
        { title: "การควบคุมภาวะสมดุล", image: "science-platform-homeostasis-regulation.png" },
        { title: "เส้นทางประสาทกับความเครียด", image: "science-platform-neuro-pathway-stress.png" },
        { title: "การทำงานของรูขุมขน", image: "science-platform-hair-follicle-function.png" }
      ]
    }
  };
  ...
  const sciencePlatformCardOrder = new Map([
    ["science-platform-exposome.png", 0],
    ["science-platform-neuro-pathway-stress.png", 1],
    ["science-platform-homeostasis-regulation.png", 2],
    ["science-platform-human-longevity-aging.png", 3],
    ["science-platform-olfactory-science.png", 4],
    ["science-platform-pssudo-synesthesia-perception.png", 5],
    ["science-platform-neuroplasticity.png", 6],
    ["science-platform-neuro-scented-therapy.png", 7],
    ["science-platform-neuro-skin-care.png", 8],
    ["science-platform-hair-follicle-function.png", 9]
  ]);
  ...
  function navLinks(text, { mobile = false, routeIds = null } = {}) {
    const navRoutes = routeIds
      ? routeIds
      ...
      <header class="site-header${headerClass ? ` ${headerClass}` : ""}">
        <div class="header-utility">
          <div class="header-utility-inner">
            <nav class="utility-nav" aria-label="Utility navigation">${navLinks(text, { routeIds: desktopUtilityNavIds })}</nav>
        ...
        <div class="header-main">
          <div class="header-inner">
            <a class="brand" href="${routeHref("home")}" aria-label="Arotec home">
              <img class="brand-logo" src="${asset("as-logo.webp")}" width="1092" height="680" alt="Arotec Scientist" decoding="async">
            </a>
            <nav class="desktop-nav" aria-label="Primary navigation">${navLinks(text, { routeIds: desktopMainNavIds })}</nav>
  ...
  function renderHome(text, lang) {
    ...
    const heroSlides = [
      {
        ...
        action: {
          href: routeHref("customized"),
          label: home.hero.secondary
        }
      },
      {
        image: "frontiers-experience.webp",
        title: "Exploring the Frontiers\nof Human Experience",
        lead: "Health, beauty and wellbeing emerge from the continuous interaction of biology, environment, lifestyle and sensory perception. Understanding these interconnected systems is key to understanding how people feel, adapt and thrive.",
        action: {
          href: routeHref("customized"),
          label: home.hero.secondary
        }
    ...
    const heroSlideLayers = heroSlides
      .map((slide, index) => `<span class="hero-slide${index === 0 ? " is-active" : ""}" data-hero-layer style="background-image:url('${asset(slide.image)}')" aria-hidden="true"></span>`)
      .join("");
    const heroDots = heroSlides.length > 1 ? heroSlides
      ...
      .join("") : "";
    const heroSlideCopies = heroSlides.map((slide, index) => `
      <div class="hero-content${index === 0 ? " is-active" : ""}" data-hero-copy aria-hidden="${index === 0 ? "false" : "true"}">
        ${slide.eyebrow ? `<p class="eyebrow">${slide.eyebrow}</p>` : ""}
        <h1 class="hero-title">${slide.title}</h1>
        <h2 class="lead">${slide.lead}</h2>
        ${slide.action ? `<div class="button-row"><a class="pill-button" href="${slide.action.href}">${slide.action.label} ${icons.arrow}</a></div>` : ""}
      </div>
    `).join("");
    const sciencePlatformLinks = {
      ...
      "science-platform-neuroplasticity.png": "pages/neuroplasticity.html",
      ...
      "science-platform-hair-follicle-function.png": "pages/hair-follicle-biology.html"
    };
    const conceptItems = platform.items.map((item) => {
      ...
      const itemAriaLabel = item.image === "science-platform-human-longevity-aging.png"
        ...
        : item.image === "science-platform-neuroplasticity.png"
          ? "Open Neuroplasticity page"
        : item.image === "science-platform-neuro-scented-therapy.png"
          ? "Open Neuro-Scented Therapy page"
        : item.title === "Neuro-Skin Science" ? "Open Neuro-Skin Science page"
          : item.image === "science-platform-hair-follicle-function.png" ? "Open Hair Follicle Biology page" : item.title;
        ...
        <section class="hero hero-slideshow" data-hero-scene>
          ...
          <div class="section-shell">
            <div class="hero-copy-stage">
              ${heroSlideCopies}
              ${heroDots ? `<div class="slider-dots hero-slider-dots" aria-label="${text.common.slideControls || "Hero slides"}">${heroDots}</div>` : ""}
            </div>
          </div>
            ...
            <div class="footer-col">
              ...
              <div class="social-row" aria-label="Social links">
                <a class="social-link" href="#" aria-label="YouTube" title="YouTube">
                  <img src="${asset("social/youtube.png")}" width="32" height="32" alt="" decoding="async">
                </a>
                <a class="social-link" href="#" aria-label="Facebook" title="Facebook">
                  <img src="${asset("social/facebook.png")}" width="32" height="32" alt="" decoding="async">
                </a>
                <a class="social-link" href="#" aria-label="Instagram" title="Instagram">
                  <img src="${asset("social/instagram.png")}" width="32" height="32" alt="" decoding="async">
                </a>
              </div>
            </div>
          </div>
  ...
  function setupHeroSlideshow() {
    ...
    const startTimer = () => {
      ...
      heroSlideTimer = window.setInterval(() => showSlide(current + 1), 10000);
    };
    ...
    hero.addEventListener("click", (event) => {
      ...
      if (control) {
        ...
        showSlide(control.dataset.heroControl === "prev" ? current - 1 : current + 1);
        restartTimer();
        return;
      }
  ...
  function setupWellbeingMobileScale() {
    ...
    const section = sectionShell?.closest(".wellbeing-cascade");
    if (!layout || !sectionShell || !section) return;
    ...
    const update = () => {
      ...
      if (window.innerWidth >= 1024) {
        sectionShell.style.removeProperty("--wellbeing-unified-scale");
        sectionShell.style.removeProperty("--wellbeing-responsive-top");
        section.style.removeProperty("--wellbeing-responsive-height");
        return;
      }

      const scale = Math.min(1, Math.max(1, window.innerWidth) / 2048);
      sectionShell.style.setProperty("--wellbeing-unified-scale", scale.toFixed(6));
      sectionShell.style.setProperty("--wellbeing-responsive-top", `${(50 * scale).toFixed(3)}px`);
      section.style.setProperty("--wellbeing-responsive-height", `${(887 * scale).toFixed(3)}px`);
    };
