/* Keep authored content outside the shared shell, which is rebuilt on language changes. */
(() => {
  "use strict";

  const start = () => {
    const shell = document.getElementById("site-shell");
    const main = document.querySelector("main#main.as-main[data-home-detail]");
    ...
    const sync = () => {
      ...
      // Home-only fragment links must still open the homepage from this detail page.
