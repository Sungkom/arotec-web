...
const desktopMainNavIds = ["customized", "applied", "products", "partners", "b2b", "insights"];
...
{ id: "vagus-spa", label: "Vagus spa", href: "pages/products.html" },
{ id: "vagus-scent-bulb", label: "Vagus scent bulb", href: "pages/products.html" },
{ id: "neuro-cosmetic", label: "Neuro-cosmetic", href: "pages/customized.html#formula" },
{ id: "customized-for-you", label: "Bespoke Services", href: "pages/customized.html" }
];
...
? `<button class="nav-link nav-dropdown-trigger${activeClass(route.id)}" type="button" aria-haspopup="true">${text.nav[route.id]}<span class="nav-dropdown-chevron" aria-hidden="true"></span></button>`
: `<a class="nav-link${dropdown ? " nav-dropdown-trigger" : ""}${activeClass(route.id)}" href="${routeHref(route.id)}"${activeAria(route.id)}${dropdown ? ' aria-haspopup="true"' : ""}>${text.nav[route.id]}${dropdown ? '<span class="nav-dropdown-chevron" aria-hidden="true"></span>' : ""}</a>`;
...
script.src = new URL('applied-products-navigation.js?v=20260908-shared-dropdown-v4', document.currentScript.src).href;
script.defer = true;
